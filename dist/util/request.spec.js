...
describe('test request module', () => {
  ...
  test('test GET with id', async () => {
    ...
    const result = await await (0, _request.request)(conn, params, {}, -1).catch(err => err.message); // request(params, data, id)
  ...
  test('test POST', async () => {
    ...
    const result = await await (0, _request.request)(conn, params, {
      id: -99
